...
public class Assignment12 {
    public static void main(String[] args) {
        ...
        Optional<Student> highestPercentStudent = students.stream().max(Comparator.comparing(Student::getPerTillDate));
        System.out.println("Highest percentage student=" + highestPercentStudent.get());
        System.out.println("----------------------------------------------------");
        ...
        System.out.println("----------------------------------------------------");
        // . Get the details of the youngest male student in the Electronic department?(Hint :Use Collectors.minBy)
        Optional<Student> student = students.stream().filter(s -> s.getEngDepartment().equals("Electronic")).min(Comparator.comparing(Student::getAge));
        ...
        computerScienceStudentsGroupByGender.forEach((k, v) -> System.out.println("Gender:" + k + " count:" + v.size()));
    }
}
